...
{
    /**
     * @var array<string, Val|Obj|Ref|Env>
     */
    private array $definitions;

    /**
     * @param array<string, Val|Obj|Ref|Env> $definitions
     */
    ...
    public function add(string $id, Val|Obj|Ref|Env $definition): self
    {
    ...
    public function get(string $id): Val|Obj|Ref|Env
    {
    ...
    /**
     * @return array<string, Val|Obj|Ref|Env>
     */
